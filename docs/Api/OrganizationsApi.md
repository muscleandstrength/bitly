...
```php
getOrganization($organization_guid): \Bitly\Model\Organization
```
...
$apiInstance = new Bitly\Api\OrganizationsApi(
...
[**\Bitly\Model\Organization**](../Model/Organization.md)
...
```php
getOrganizationShortenCounts($organization_guid, $unit, $units, $unit_reference): \Bitly\Model\Metrics
```
...
```php
getOrganizations(): \Bitly\Model\Organizations
```
...
[**\Bitly\Model\Organizations**](../Model/Organizations.md)
...
```php
getPlanLimits($organization_guid): \Bitly\Model\PlanLimits
```
...
[**\Bitly\Model\PlanLimits**](../Model/PlanLimits.md)
