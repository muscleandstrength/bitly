...
```php
createWebhook($webhook_create): \Bitly\Model\Webhook
```
...
$apiInstance = new Bitly\Api\WebhooksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$webhook_create = new \Bitly\Model\WebhookCreate(); // \Bitly\Model\WebhookCreate
...
------------- | ------------- | ------------- | -------------
 **webhook_create** | [**\Bitly\Model\WebhookCreate**](../Model/WebhookCreate.md)|  |

### Return type

[**\Bitly\Model\Webhook**](../Model/Webhook.md)
...
```php
getWebhook($webhook_guid): \Bitly\Model\Webhook
```
...
```php
getWebhooks($organization_guid): \Bitly\Model\Webhooks
```
...
[**\Bitly\Model\Webhooks**](../Model/Webhooks.md)
...
```php
updateWebhook($webhook_guid, $webhook_update): \Bitly\Model\Webhook
```
...
$webhook_guid = Wa1bcDefG23; // string | A GUID for a Bitly webhook
$webhook_update = new \Bitly\Model\WebhookUpdate(); // \Bitly\Model\WebhookUpdate
...
------------- | ------------- | ------------- | -------------
 **webhook_guid** | **string**| A GUID for a Bitly webhook |
 **webhook_update** | [**\Bitly\Model\WebhookUpdate**](../Model/WebhookUpdate.md)|  |
...
```php
verifyWebhook($webhook_guid): \Bitly\Model\Webhook
```
