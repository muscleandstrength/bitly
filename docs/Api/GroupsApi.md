...
```php
getGroup($group_guid): \Bitly\Model\Group
```
...
$apiInstance = new Bitly\Api\GroupsApi(
...
[**\Bitly\Model\Group**](../Model/Group.md)
...
```php
getGroupClicks($group_guid, $unit, $units, $unit_reference): \Bitly\Model\GroupClicks
```
...
[**\Bitly\Model\GroupClicks**](../Model/GroupClicks.md)
...
```php
getGroupMetricsByCities($group_guid, $unit, $units, $size, $unit_reference): \Bitly\Model\CityMetrics
```
...
```php
getGroupMetricsByCountries($group_guid, $unit, $units, $size, $unit_reference): \Bitly\Model\ClickMetrics
```
...
```php
getGroupMetricsByDevices($group_guid, $unit, $units, $size, $unit_reference): \Bitly\Model\DeviceMetrics
```
...
```php
getGroupMetricsByReferringNetworks($group_guid): \Bitly\Model\ClickMetrics
```
...
```php
getGroupPreferences($group_guid): \Bitly\Model\GroupPreferences
```
...
[**\Bitly\Model\GroupPreferences**](../Model/GroupPreferences.md)
...
```php
getGroupShortenCounts($group_guid, $unit, $units, $unit_reference): \Bitly\Model\Metrics
```
...
[**\Bitly\Model\Metrics**](../Model/Metrics.md)
...
```php
getGroupTags($group_guid): \Bitly\Model\Tags
```
...
[**\Bitly\Model\Tags**](../Model/Tags.md)
...
```php
getGroups($organization_guid): \Bitly\Model\Groups
```
...
[**\Bitly\Model\Groups**](../Model/Groups.md)
...
```php
updateGroup($group_guid, $group_update): \Bitly\Model\Group
```
...
$group_guid = Ba1bc23dE4F; // string | A GUID for a Bitly group
$group_update = new \Bitly\Model\GroupUpdate(); // \Bitly\Model\GroupUpdate
...
------------- | ------------- | ------------- | -------------
 **group_guid** | **string**| A GUID for a Bitly group |
 **group_update** | [**\Bitly\Model\GroupUpdate**](../Model/GroupUpdate.md)|  |
...
```php
updateGroupPreferences($group_guid, $group_preferences): \Bitly\Model\GroupPreferences
```
...
$group_guid = Ba1bc23dE4F; // string | A GUID for a Bitly group
$group_preferences = new \Bitly\Model\GroupPreferences(); // \Bitly\Model\GroupPreferences
...
------------- | ------------- | ------------- | -------------
 **group_guid** | **string**| A GUID for a Bitly group |
 **group_preferences** | [**\Bitly\Model\GroupPreferences**](../Model/GroupPreferences.md)|  |
