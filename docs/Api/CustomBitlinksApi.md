...
```php
addCustomBitlink($add_custom_bitlink): \Bitly\Model\CustomBitlink
```
...
$apiInstance = new Bitly\Api\CustomBitlinksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$add_custom_bitlink = new \Bitly\Model\AddCustomBitlink(); // \Bitly\Model\AddCustomBitlink
...
------------- | ------------- | ------------- | -------------
 **add_custom_bitlink** | [**\Bitly\Model\AddCustomBitlink**](../Model/AddCustomBitlink.md)|  |

### Return type

[**\Bitly\Model\CustomBitlink**](../Model/CustomBitlink.md)
...
```php
getClicksForCustomBitlink($custom_bitlink, $unit, $units, $unit_reference): \Bitly\Model\Clicks
```
...
```php
getCustomBitlink($custom_bitlink): \Bitly\Model\CustomBitlink
```
...
```php
getCustomBitlinkMetricsByDestination($custom_bitlink, $unit, $units, $unit_reference): \Bitly\Model\ClickMetrics
```
...
```php
updateCustomBitlink($custom_bitlink, $update_custom_bitlink): \Bitly\Model\CustomBitlink
```
...
$custom_bitlink = chauncey.ly/chauncey; // string | A Custom Bitlink made of the domain and keyword
$update_custom_bitlink = new \Bitly\Model\UpdateCustomBitlink(); // \Bitly\Model\UpdateCustomBitlink
...
------------- | ------------- | ------------- | -------------
 **custom_bitlink** | **string**| A Custom Bitlink made of the domain and keyword |
 **update_custom_bitlink** | [**\Bitly\Model\UpdateCustomBitlink**](../Model/UpdateCustomBitlink.md)|  |
