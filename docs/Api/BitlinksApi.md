...
```php
createBitlink($shorten): \Bitly\Model\ShortenBitlinkBody
```
...
$apiInstance = new Bitly\Api\BitlinksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$shorten = new \Bitly\Model\Shorten(); // \Bitly\Model\Shorten
...
------------- | ------------- | ------------- | -------------
 **shorten** | [**\Bitly\Model\Shorten**](../Model/Shorten.md)|  |

### Return type

[**\Bitly\Model\ShortenBitlinkBody**](../Model/ShortenBitlinkBody.md)
...
```php
createFullBitlink($full_shorten): \Bitly\Model\BitlinkBody
```
...
$full_shorten = new \Bitly\Model\FullShorten(); // \Bitly\Model\FullShorten
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **full_shorten** | [**\Bitly\Model\FullShorten**](../Model/FullShorten.md)|  |

### Return type

[**\Bitly\Model\BitlinkBody**](../Model/BitlinkBody.md)
...
```php
expandBitlink($expand_bitlink): \Bitly\Model\ExpandedBitlink
```
...
$expand_bitlink = new \Bitly\Model\ExpandBitlink(); // \Bitly\Model\ExpandBitlink
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **expand_bitlink** | [**\Bitly\Model\ExpandBitlink**](../Model/ExpandBitlink.md)|  |

### Return type

[**\Bitly\Model\ExpandedBitlink**](../Model/ExpandedBitlink.md)
...
```php
getBitlink($bitlink): \Bitly\Model\BitlinkBody
```
...
```php
getBitlinkQRCode($bitlink, $color, $exclude_bitly_logo, $image_format): \Bitly\Model\BitlinkQR
```
...
[**\Bitly\Model\BitlinkQR**](../Model/BitlinkQR.md)
...
```php
getBitlinksByGroup($group_guid, $size, $page, $keyword, $query, $created_before, $created_after, $modified_after, $archived, $deeplinks, $domain_deeplinks, $campaign_guid, $channel_guid, $custom_bitlink, $tags, $launchpad_ids, $encoding_login): \Bitly\Model\Bitlinks
```
...
[**\Bitly\Model\Bitlinks**](../Model/Bitlinks.md)
...
```php
getClicksForBitlink($bitlink, $unit, $units, $unit_reference): \Bitly\Model\Clicks
```
...
[**\Bitly\Model\Clicks**](../Model/Clicks.md)
...
```php
getClicksSummaryForBitlink($bitlink, $unit, $units, $unit_reference): \Bitly\Model\ClicksSummary
```
...
[**\Bitly\Model\ClicksSummary**](../Model/ClicksSummary.md)
...
```php
getMetricsForBitlinkByCities($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\CityMetrics
```
...
[**\Bitly\Model\CityMetrics**](../Model/CityMetrics.md)
...
```php
getMetricsForBitlinkByCountries($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\ClickMetrics
```
...
[**\Bitly\Model\ClickMetrics**](../Model/ClickMetrics.md)
...
```php
getMetricsForBitlinkByDevices($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\DeviceMetrics
```
...
[**\Bitly\Model\DeviceMetrics**](../Model/DeviceMetrics.md)
...
```php
getMetricsForBitlinkByReferrers($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\ClickMetrics
```
...
```php
getMetricsForBitlinkByReferrersByDomains($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\ReferrersByDomains
```
...
[**\Bitly\Model\ReferrersByDomains**](../Model/ReferrersByDomains.md)
...
```php
getMetricsForBitlinkByReferringDomains($bitlink, $unit, $units, $size, $unit_reference): \Bitly\Model\ClickMetrics
```
...
```php
getSortedBitlinks($group_guid, $sort, $unit, $units, $unit_reference, $size): \Bitly\Model\SortedLinks
```
...
[**\Bitly\Model\SortedLinks**](../Model/SortedLinks.md)
...
```php
updateBitlink($bitlink, $bitlink_body): \Bitly\Model\BitlinkBody
```
...
$bitlink = bit.ly/12a4b6c; // string | A Bitlink made of the domain and hash
$bitlink_body = new \Bitly\Model\BitlinkBody(); // \Bitly\Model\BitlinkBody
...
------------- | ------------- | ------------- | -------------
 **bitlink** | **string**| A Bitlink made of the domain and hash |
 **bitlink_body** | [**\Bitly\Model\BitlinkBody**](../Model/BitlinkBody.md)|  |
...
```php
updateBitlinksByGroup($group_guid, $bulk_update_request): \Bitly\Model\BulkUpdate
```
...
$group_guid = Ba1bc23dE4F; // string | A GUID for a Bitly group
$bulk_update_request = new \Bitly\Model\BulkUpdateRequest(); // \Bitly\Model\BulkUpdateRequest
...
------------- | ------------- | ------------- | -------------
 **group_guid** | **string**| A GUID for a Bitly group |
 **bulk_update_request** | [**\Bitly\Model\BulkUpdateRequest**](../Model/BulkUpdateRequest.md)|  |

### Return type

[**\Bitly\Model\BulkUpdate**](../Model/BulkUpdate.md)
