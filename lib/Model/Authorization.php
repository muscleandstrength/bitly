...
class Authorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'app' => '\OpenAPI\Client\Model\OAuthAppWithOwnerLogin',
        'id' => 'string',
        'client_id' => 'string',
        'created' => 'string'
    ];
     ...
     * Gets app
     *
     * @return \OpenAPI\Client\Model\OAuthAppWithOwnerLogin|null
     */
     ...
     * Sets app
     *
     * @param \OpenAPI\Client\Model\OAuthAppWithOwnerLogin|null $app app
     *
     * @return self
     */
