...
class CampaignClicksData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'brand_guid' => 'string',
        'campaign_channels' => '\OpenAPI\Client\Model\CampaignChannelClicks[]',
        'created_by' => 'string',
        'modified_ts' => 'int',
        'total_clicks' => 'int',
        'guid' => 'string',
     ...
     *
     * @return \OpenAPI\Client\Model\CampaignChannelClicks[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CampaignChannelClicks[]|null $campaign_channels campaign_channels
     *
     * @return self
     */
